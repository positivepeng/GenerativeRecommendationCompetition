...
class SASRec(paddle.nn.Layer):
    ...
    def predict_batch(self, log_seqs, item_indices):  # for inference
        log_seqs = paddle.to_tensor(log_seqs, dtype='int64')
        item_indices = paddle.to_tensor(item_indices, dtype='int64')
